...
\* \*\*Languages:\*\* Python (Automation \& Scripting), PowerShell, Bash

\* \*\*Environment:\*\* VirtualBox Lab (Ubuntu Server, Windows 10 Pro)

\* \*\*Tools:\*\* Wazuh (SIEM), tcpdump, Tshark/Wireshark, Termux (Mobile PCAP)
